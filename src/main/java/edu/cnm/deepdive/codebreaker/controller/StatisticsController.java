...
public class StatisticsController {
  ...
  List<GameStatistics> get(
      @RequestParam("pool-size") int poolSize,
      @RequestParam("code-length") int codeLength,
      @RequestParam("games-played") int gamesPlayedThreshold
  ){
    return statisticsService.getWithThreshold(poolSize, codeLength, gamesPlayedThreshold);
  }
